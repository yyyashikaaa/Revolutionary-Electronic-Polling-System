...
if (move_uploaded_file($_FILES['fileupload']['tmp_name'], $target)) { 
    ...
    $sql= "insert into c_register(fname,lname,acn,vid,address,constituency,gender,dob,number,mail,pname,pic)values('$fname','$lname','$acn','$vid','$address','$constituency','$gender','$dob','$number','$mail','$pname','$pic')";
